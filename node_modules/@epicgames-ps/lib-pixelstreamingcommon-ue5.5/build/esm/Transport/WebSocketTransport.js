...
export class WebSocketTransport extends EventEmitter {
    ...
    connect(connectionURL) {
        ...
        try {
            ...
            Logger.Error(Logger.GetStackTrace(), error);
            return false;
        }
    }
    /**
    ...
    handleOnMessageBinary(event) {
        ...
        event.data
            ...
            .catch((error) => {
            Logger.Error(Logger.GetStackTrace(), `Failed to parse binary blob from websocket, reason: ${error.message}`);
        });
    }
    /**
     ...
     */
    handleOnClose(event) {
        Logger.Log(Logger.GetStackTrace(), 'Disconnected to the signalling server via WebSocket: ' +
